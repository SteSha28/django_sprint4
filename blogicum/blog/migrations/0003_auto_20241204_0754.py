# Generated by Django 3.2.16 on 2024-12-04 07:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0002_rename_is_publlished_post_is_published'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='location',
            field=models.ForeignKey(blank=True, help_text='Необязательное поле', null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.location', verbose_name='Местоположение'),
        ),
        migrations.AlterField(
            model_name='post',
            name='pub_date',
